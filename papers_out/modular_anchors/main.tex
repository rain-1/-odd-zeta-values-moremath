...
sporadic rows, $r=3$ for the six ``weight-3'' rows. For these families the
modular weight of $F$ is $r-1$ and the congruence weight $w$ of the
programme's tables equals $r$. We use $r$ exclusively in operator
...
$29\le p\le97$ for each of the six families; \texttt{eps57\_heldout.py}}\quad
