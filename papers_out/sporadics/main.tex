...
seven remain conjectural. On the closed-form side we record a proof, formalised in Lean~4,
...
sporadic sequence). We therefore record Observation~\ref{obs:integrality} as computed, and
